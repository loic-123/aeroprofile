...
def power_model(
    ...
    """Modelled measured power (W). Vectorised.
    ...
    # V_air² uses sign(V_air) × V_air² so tailwind stronger than ground speed
    # drives negative aero power (physical: rider pushed by wind)
